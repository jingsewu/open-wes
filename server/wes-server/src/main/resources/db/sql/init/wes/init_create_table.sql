...
CREATE TABLE `w_operation_task`  (
                                     ...
                                     `work_station_id` bigint NOT NULL COMMENT '工作站ID',
                                     PRIMARY KEY (`id`) USING BTREE,
                                     INDEX `idx_source_container_code`(`source_container_code` ASC) USING BTREE,
                                     INDEX `idx_work_station_target_location`(`work_station_id` ASC, `target_location_code` ASC) USING BTREE,
