...
CREATE TABLE `a_api_config`  (
                                 ...
                                 `param_converter_type` smallint(6) NULL DEFAULT NULL,
                                 `response_converter_type` smallint(6) NULL DEFAULT NULL,
...
CREATE TABLE `e_container_task`  (
                                     ...
                                     `parent_container_task_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '父容器任务ID',
                                     ...
                                     `task_group_priority` int(11) NOT NULL DEFAULT 0 COMMENT '组任务优先级',
                                     `task_priority` int(11) NOT NULL DEFAULT 0 COMMENT '任务优先级',
...
CREATE TABLE `e_container_task_and_business_task_relation`  (
                                                                ...
                                                                `customer_task_id` bigint(11) NULL DEFAULT NULL COMMENT '客户任务ID',
                                                                `task_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '搬箱任务编号',
                                                                `task_id` bigint(11) NULL DEFAULT NULL COMMENT '搬箱任务ID',
                                                                PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `e_ems_location_config`  (
                                          ...
                                          `warehouse_area_id` bigint(11) NOT NULL COMMENT '库区ID',
...
CREATE TABLE `m_address`  (
                              ...
                              PRIMARY KEY (`id`) USING BTREE,
                              UNIQUE INDEX `uk_c_p_c_d`(`country`, `province`, `city`, `district`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_barcode_parse_rule`  (
                                         ...
                                         `version` bigint(20) NULL DEFAULT NULL,
                                         PRIMARY KEY (`id`) USING BTREE,
                                         UNIQUE INDEX `uk_barcode_parse_code`(`code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_batch_attribute_config`  (
                                             ...
                                             `version` bigint(20) NULL DEFAULT NULL,
                                             PRIMARY KEY (`id`) USING BTREE,
                                             UNIQUE INDEX `uk_batch_attribute_config_code`(`code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_dictionary`  (
                                 ...
                                 PRIMARY KEY (`id`) USING BTREE,
                                 UNIQUE INDEX `uk_dictionary_code`(`code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_owner_main_data`  (
                                      ...
                                      PRIMARY KEY (`id`) USING BTREE,
                                      UNIQUE INDEX `uk_owner_warehouse`(`owner_code`, `warehouse_code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_sku_barcode_data`  (
                                       ...
                                       PRIMARY KEY (`id`) USING BTREE,
                                       UNIQUE INDEX `uk_sku_id_and_barcode`(`sku_id`, `bar_code`) USING BTREE,
                                       INDEX `idx_barcode`(`bar_code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_sku_main_data`  (
                                    ...
                                    `effective_days` int(11) NOT NULL COMMENT '效期限制天数',
                                    `enable_effective` bit(1) NOT NULL,
                                    `enable_sn` bit(1) NOT NULL,
                                    `gross_weight` bigint(20) NOT NULL COMMENT '净重',
                                    ...
                                    `max_stock` int(11) NULL DEFAULT NULL COMMENT '库存上限',
                                    `min_stock` int(11) NULL DEFAULT NULL COMMENT '库存下限',
                                    `net_weight` bigint(20) NOT NULL COMMENT '毛重',
                                    `no_barcode` bit(1) NOT NULL,
                                    `owner_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货主编码',
                                    `shelf_life` int(11) NOT NULL COMMENT '保质期(天)',
                                    ...
                                    `version` bigint(20) NULL DEFAULT NULL,
                                    `volume` bigint(20) NOT NULL COMMENT '体积',
                                    `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                    `width` bigint(20) NOT NULL COMMENT '宽度',
                                    PRIMARY KEY (`id`) USING BTREE,
                                    UNIQUE INDEX `uk_sku_owner_warehouse`(`sku_code`, `owner_code`, `warehouse_code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_system_config`  (
                                    ...
                                    `version` bigint(20) NULL DEFAULT NULL,
                                    PRIMARY KEY (`id`) USING BTREE,
                                    UNIQUE INDEX `uk_singleton_key`(`singleton_key`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `p_print_config`  (
                                   ...
                                   PRIMARY KEY (`id`) USING BTREE,
                                   UNIQUE INDEX `idx_print_config_code`(`config_code`, `delete_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `p_print_rule`  (
                                 ...
                                 `print_count` int(11) NOT NULL DEFAULT 1 COMMENT '打印份数',
                                 ...
                                 PRIMARY KEY (`id`) USING BTREE,
                                 UNIQUE INDEX `idx_print_rule_code`(`rule_code`, `delete_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `u_login_log`  (
                                ...
                                `login_result` int(11) NOT NULL COMMENT '登录结果(1成功, 2失败)',
                                PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `u_menu`  (
                           ...
                           `enable` int(11) NOT NULL COMMENT '是否启用(1启用, 0禁用)',
                           `icon` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图标',
                           `iframe_show` int(11) NULL DEFAULT NULL COMMENT '是否以 iframe 的方式显示(1启用, 0禁用)',
                           `order_num` int(11) NOT NULL COMMENT '排序，数字越小越靠前',
                           `parent_id` bigint(20) NOT NULL COMMENT '父菜单id,如果是顶级菜单, 则为0',
                           ...
                           `type` int(11) NOT NULL COMMENT '类型(1: 系统、2: 菜单、3: 权限)',
                           PRIMARY KEY (`id`) USING BTREE,
                           INDEX `idx_system_code`(`system_code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `u_user`  (
                           ...
                           `locked` int(11) NOT NULL COMMENT '是否被锁(小于等于5表示未被锁, 大于5表示被锁)',
...
CREATE TABLE `w_accept_order`  (
                                   ...
                                   `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                   `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                   `audit_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'audit time',
                                   ...
                                   `total_box` int(11) NOT NULL DEFAULT 0 COMMENT '验收总箱数',
                                   `total_qty` int(11) NOT NULL DEFAULT 0 COMMENT '验收总数量',
                                   `version` bigint(20) NULL DEFAULT NULL,
                                   `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库',
                                   PRIMARY KEY (`id`) USING BTREE,
                                   UNIQUE INDEX `uk_order_no`(`order_no`) USING BTREE,
                                   INDEX `idx_identify_no`(`identify_no`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_accept_order_detail`  (
                                          ...
                                          `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                          `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                          `accept_order_id` bigint(20) NOT NULL COMMENT '验收单ID',
                                          ...
                                          `brand` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '品牌',
                                          `color` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '颜色',
                                          `inbound_plan_order_detail_id` bigint(20) NOT NULL COMMENT '入库通知单明细ID',
                                          `inbound_plan_order_id` bigint(20) NOT NULL COMMENT '入库通知单ID',
                                          `owner_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货主编码',
                                          `pack_box_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '箱号',
                                          `qty_accepted` int(11) NOT NULL COMMENT '验收数量',
                                          `size` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '尺码',
                                          `sku_batch_attribute_id` bigint(20) NOT NULL,
                                          `sku_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'sku编码',
                                          ...
                                          `target_container_id` bigint(20) NOT NULL,
                                          ...
                                          `work_station_id` bigint(20) NOT NULL COMMENT '工作站ID',
                                          PRIMARY KEY (`id`) USING BTREE,
                                          INDEX `idx_inbound_plan_order_detail_id`(`inbound_plan_order_detail_id`) USING BTREE,
                                          INDEX `idx_inbound_plan_order__id`(`inbound_plan_order_id`) USING BTREE,
                                          INDEX `idx_accept_order_id`(`accept_order_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_aisle`  (
                            ...
                            `warehouse_area_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '库区ID',
                            PRIMARY KEY (`id`) USING BTREE,
                            UNIQUE INDEX `uk_aisle_code_warehouse_area`(`aisle_code`, `warehouse_area_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_container`  (
                                ...
                                `container_slot_num` int(11) NOT NULL DEFAULT 0 COMMENT '格口数量',
                                ...
                                `empty_slot_num` int(11) NOT NULL DEFAULT 0 COMMENT '空格口数量',
                                ...
                                `warehouse_logic_id` bigint(20) NOT NULL COMMENT '逻辑区ID',
                                PRIMARY KEY (`id`) USING BTREE,
                                UNIQUE INDEX `uk_container_code_warehouse_code`(`container_code`, `warehouse_code`) USING BTREE,
                                INDEX `idx_container_spec_code`(`container_spec_code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_container_spec`  (
                                     ...
                                     `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                     `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                     `container_slot_num` int(11) NOT NULL DEFAULT 0 COMMENT '格子数量',
                                     ...
                                     `width` bigint(20) NOT NULL COMMENT '宽度',
                                     PRIMARY KEY (`id`) USING BTREE,
                                     UNIQUE INDEX `uk_container_spec_code_warehouse`(`container_spec_code`, `warehouse_code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_container_stock`  (
                                      ...
                                      `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                      `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                      `available_qty` int(11) NOT NULL DEFAULT 0 COMMENT '可用数量',
                                      `box_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '箱号',
                                      ...
                                      `no_outbound_locked_qty` int(11) NOT NULL DEFAULT 0 COMMENT '库内锁定数量',
                                      `outbound_locked_qty` int(11) NOT NULL DEFAULT 0 COMMENT '出库锁定数量',
                                      `sku_batch_attribute_id` bigint(20) NOT NULL DEFAULT 0 COMMENT 'skuBatchAttributeId',
                                      `sku_batch_stock_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '批次库存id',
                                      `sku_id` bigint(20) NOT NULL DEFAULT 0 COMMENT 'skuId',
                                      `total_qty` int(11) NOT NULL DEFAULT 0 COMMENT '总数量',
                                      `version` bigint(20) NULL DEFAULT NULL,
                                      `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                      PRIMARY KEY (`id`) USING BTREE,
                                      UNIQUE INDEX `uk_container_slot_sku_batch`(`container_code`, `container_slot_code`, `sku_batch_stock_id`) USING BTREE,
                                      INDEX `idx_sku_batch_stock_id`(`sku_batch_stock_id`) USING BTREE,
...
CREATE TABLE `w_container_stock_transaction`  (
                                                  ...
                                                  `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                                  `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                                  `container_stock_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '明细库存id',
                                                  ...
                                                  `transfer_qty` int(11) NOT NULL DEFAULT 0 COMMENT '数量',
                                                  `version` bigint(20) NULL DEFAULT NULL,
                                                  `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                                  PRIMARY KEY (`id`) USING BTREE,
                                                  INDEX `idx_container_code`(`source_container_code`) USING BTREE,
...
CREATE TABLE `w_empty_container_inbound_order`  (
                                                    ...
                                                    `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                                    PRIMARY KEY (`id`) USING BTREE,
                                                    UNIQUE INDEX `uk_empty_container_inbound_order_order_no`(`order_no`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_empty_container_inbound_order_detail`  (
                                                           ...
                                                           `container_spec_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '容器规格',
                                                           `empty_container_inbound_order_id` bigint(20) NOT NULL COMMENT '空箱入库单ID',
                                                           `inbound_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '状态',
                                                           `location_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '地面码',
                                                           PRIMARY KEY (`id`) USING BTREE,
                                                           INDEX `idx_empty_container_inbound_order_id`(`empty_container_inbound_order_id`) USING BTREE,
...
CREATE TABLE `w_inbound_plan_order`  (
                                         ...
                                         `estimated_arrival_date` bigint(20) NOT NULL COMMENT '预计到达时间',
                                         ...
                                         PRIMARY KEY (`id`) USING BTREE,
                                         UNIQUE INDEX `uk_order_no`(`order_no`) USING BTREE,
                                         INDEX `idx_customer_order_no`(`customer_order_no`) USING BTREE,
                                         INDEX `idx_lpn`(`lpn_code`) USING BTREE,
                                         INDEX `idx_inbound_plan_order_status`(`inbound_plan_order_status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_inbound_plan_order_detail`  (
                                                ...
                                                `inbound_plan_order_id` bigint(20) NOT NULL COMMENT '入库通知单ID',
                                                `owner_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货主编码',
                                                `qty_abnormal` int(11) NOT NULL COMMENT '异常数量',
                                                `qty_accepted` int(11) NOT NULL COMMENT '验收数量',
                                                `qty_restocked` int(11) NOT NULL COMMENT '计划数量',
                                                `qty_unreceived` int(11) NOT NULL COMMENT '未收货数量',
                                                ...
                                                `style` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '款式',
                                                PRIMARY KEY (`id`) USING BTREE,
                                                INDEX `idx_inbound_plan_order_id`(`inbound_plan_order_id`) USING BTREE,
...
CREATE TABLE `w_location`  (
                               ...
                               `warehouse_area_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '库区ID',
                               `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                               `warehouse_logic_id` bigint(20) NULL DEFAULT 0 COMMENT '逻辑区ID',
                               PRIMARY KEY (`id`) USING BTREE,
                               UNIQUE INDEX `uk_warehouse_area_location`(`location_code`, `warehouse_area_id`) USING BTREE,
                               INDEX `idx_aisle_warehouse_area`(`aisle_code`, `warehouse_area_id`) USING BTREE,
                               INDEX `idx_warehouse_area_id`(`warehouse_area_id`) USING BTREE,
                               INDEX `idx_warehouse_logic_id`(`warehouse_logic_id`) USING BTREE,
                               INDEX `idx_shelf_code`(`shelf_code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_operation_task`  (
                                     ...
                                     `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                     `abnormal` bit(1) NOT NULL,
                                     `abnormal_qty` int(11) NOT NULL COMMENT '异常数量',
                                     ...
                                     `container_stock_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '容器库存ID',
                                     `detail_id` bigint(20) NOT NULL COMMENT '单据明细ID',
                                     `operated_qty` int(11) NOT NULL COMMENT '操作数量',
                                     `order_id` bigint(20) NOT NULL COMMENT '单据ID：可能是拣货单/理货单',
                                     `order_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '订单号',
                                     `priority` int(11) NOT NULL DEFAULT 0 COMMENT 'priority',
                                     `required_qty` int(11) NOT NULL COMMENT '需求数量',
                                     `sku_batch_attribute_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '批次ID',
                                     `sku_batch_stock_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '批次库存ID',
                                     ...
                                     `work_station_id` bigint(20) NOT NULL COMMENT '工作站ID',
                                     PRIMARY KEY (`id`) USING BTREE,
                                     INDEX `idx_status_source_container_code`(`task_status`, `source_container_code`) USING BTREE,
                                     INDEX `idx_transfer_container_record_id`(`transfer_container_record_id`) USING BTREE,
                                     INDEX `idx_picking_order_id`(`order_id`, `detail_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_outbound_plan_order`  (
                                          ...
                                          `expired_time` bigint(20) NOT NULL COMMENT '截单时间',
                                          `order_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '订单编号',
                                          ...
                                          UNIQUE INDEX `uk_order_no`(`order_no`) USING BTREE,
                                          INDEX `idx_customer_order_no`(`customer_order_no`) USING BTREE,
                                          INDEX `idx_customer_wave_no`(`customer_wave_no`) USING BTREE,
                                          INDEX `idx_outbound_plan_order_status`(`outbound_plan_order_status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_outbound_plan_order_detail`  (
                                                 ...
                                                 `outbound_plan_order_id` bigint(20) NOT NULL COMMENT '出库计划单ID',
                                                 `owner_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货主编码',
                                                 `qty_actual` int(11) NOT NULL COMMENT '实际拣货数量',
                                                 `qty_allocated` int(11) NOT NULL COMMENT '预占的批次库存数量',
                                                 `qty_required` int(11) NOT NULL COMMENT '计划数量',
                                                 `reserved_fields` json NULL COMMENT '扩展字段',
                                                 `sku_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'sku编码',
                                                 `sku_id` bigint(20) NOT NULL COMMENT 'skuID',
                                                 `sku_name` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'sku名称',
                                                 ...
                                                 PRIMARY KEY (`id`) USING BTREE,
                                                 INDEX `idx_outbound_plan_order_id`(`outbound_plan_order_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_outbound_pre_allocated_record`  (
                                                    ...
                                                    `create_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Create user',
                                                    `batch_attributes` json NULL COMMENT '批次属性',
                                                    `outbound_plan_order_detail_id` bigint(20) NOT NULL COMMENT '出库计划单明细ID',
                                                    `outbound_plan_order_id` bigint(20) NOT NULL COMMENT '出库计划单ID',
                                                    `owner_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货主',
                                                    `qty_pre_allocated` int(11) NOT NULL COMMENT '预占用数量',
                                                    `sku_batch_stock_id` bigint(20) NOT NULL COMMENT 'sku batch stock ID',
                                                    `sku_id` bigint(20) NOT NULL COMMENT 'skuID',
                                                    `version` bigint(20) NULL DEFAULT NULL,
                                                    `warehouse_area_id` bigint(20) NOT NULL COMMENT 'warehouse area ID',
...
CREATE TABLE `w_outbound_wave`  (
                                    ...
                                    PRIMARY KEY (`id`) USING BTREE,
                                    UNIQUE INDEX `uk_wave_no`(`wave_no`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_picking_order`  (
                                    ...
                                    `short_outbound` bit(1) NOT NULL,
                                    `version` bigint(20) NULL DEFAULT NULL,
                                    `warehouse_area_id` bigint(20) NOT NULL COMMENT '库区',
                                    `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库',
                                    `wave_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '波次号',
                                    PRIMARY KEY (`id`) USING BTREE,
                                    UNIQUE INDEX `uk_picking_order_no`(`picking_order_no`) USING BTREE,
                                    INDEX `idx_received_user_account`(`received_user_account`) USING BTREE,
...
CREATE TABLE `w_picking_order_detail`  (
                                           ...
                                           `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                           `batch_attributes` json NULL COMMENT '批次属性',
                                           `outbound_order_plan_detail_id` bigint(20) NOT NULL COMMENT '出库计划单明细ID',
                                           `outbound_order_plan_id` bigint(20) NOT NULL COMMENT '出库计划单ID',
                                           `owner_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货主',
                                           ...
                                           `qty_abnormal` int(11) NOT NULL COMMENT '异常登记数量',
                                           `qty_actual` int(11) NOT NULL COMMENT '实际拣货数量',
                                           `qty_required` int(11) NOT NULL COMMENT '计划数量',
                                           `qty_short` int(11) NOT NULL COMMENT '缺拣数量',
                                           `retargeting_warehouse_area_ids` json NULL COMMENT '库存重定位库区IDS',
                                           `sku_batch_stock_id` bigint(20) NOT NULL COMMENT 'sku batch stock ID',
                                           `sku_id` bigint(20) NOT NULL COMMENT 'skuID',
                                           `version` bigint(20) NULL DEFAULT NULL,
                                           PRIMARY KEY (`id`) USING BTREE,
                                           INDEX `idx_picking_order_id`(`picking_order_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_put_away_task`  (
                                    ...
                                    `version` bigint(20) NULL DEFAULT NULL,
                                    `warehouse_area_id` bigint(20) NOT NULL,
                                    `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '仓库编码',
                                    `work_station_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '工作台ID',
                                    PRIMARY KEY (`id`) USING BTREE,
                                    UNIQUE INDEX `uk_order_no`(`task_no`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

CREATE TABLE `w_put_away_task_detail`  (
                                           `id` bigint(20) NOT NULL,
                                           `accept_order_detail_id` bigint(20) NOT NULL COMMENT 'accept order detail id',
                                           `accept_order_id` bigint(20) NOT NULL COMMENT 'accept order id',
                                           `batch_attributes` json NULL COMMENT '批次属性',
                                           `container_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '容器编码',
                                           ...
                                           `extend_fields` json NULL COMMENT '扩展字段',
                                           `owner_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货主编码',
                                           `put_away_task_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '上架任务ID',
                                           `qty_put_away` bigint(20) NOT NULL DEFAULT 0 COMMENT '上架数量',
                                           `sku_batch_attribute_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '批次属性 ID',
                                           ...
                                           PRIMARY KEY (`id`) USING BTREE,
                                           INDEX `idx_put_away_task_id`(`put_away_task_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_put_wall`  (
                               ...
                               `version` bigint(20) NULL DEFAULT NULL,
                               `work_station_id` bigint(11) NOT NULL COMMENT '工作站ID',
                               PRIMARY KEY (`id`) USING BTREE,
                               UNIQUE INDEX `uk_put_wall_work_station`(`put_wall_code`, `work_station_id`, `delete_time`) USING BTREE,
                               INDEX `idx_work_station`(`work_station_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_put_wall_slot`  (
                                    ...
                                    `loc_bay` int(11) NULL DEFAULT NULL COMMENT '所在列',
                                    `loc_level` int(11) NULL DEFAULT NULL COMMENT '所在层',
                                    `picking_order_id` bigint(11) NOT NULL COMMENT '已分配拣选单ID',
                                    `ptl_tag` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '电子标签号',
                                    `put_wall_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '播种墙编码',
                                    `put_wall_id` bigint(11) NOT NULL COMMENT '播种墙ID',
                                    ...
                                    `transfer_container_record_id` bigint(11) NULL DEFAULT NULL COMMENT '周转容器记录ID',
                                    `version` bigint(20) NULL DEFAULT NULL,
                                    `work_station_id` bigint(11) NOT NULL COMMENT '工作站ID',
                                    PRIMARY KEY (`id`) USING BTREE,
                                    UNIQUE INDEX `uk_work_station_slot_code`(`work_station_id`, `put_wall_slot_code`) USING BTREE,
                                    INDEX `idx_put_wall_id`(`put_wall_id`) USING BTREE,
                                    INDEX `idx_picking_order_id`(`picking_order_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_sku_batch_attribute`  (
                                          ...
                                          `version` bigint(20) NULL DEFAULT NULL,
                                          PRIMARY KEY (`id`) USING BTREE,
                                          UNIQUE INDEX `idx_sku_batch_no`(`sku_id`, `batch_no`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_sku_batch_stock`  (
                                      ...
                                      `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                      PRIMARY KEY (`id`) USING BTREE,
                                      UNIQUE INDEX `idx_sku_batch_attribute_warehouse_area`(`sku_batch_attribute_id`, `warehouse_area_id`) USING BTREE,
                                      INDEX `idx_sku_id_warehouse_area`(`sku_id`, `warehouse_area_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_stock_abnormal_record`  (
                                            ...
                                            `container_stock_id` bigint(20) NOT NULL COMMENT '库存id',
                                            ...
                                            `owner_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货主编码',
                                            `qty_abnormal` int(11) NOT NULL COMMENT '盈亏',
                                            ...
                                            `sku_batch_attribute_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '批次id',
                                            `sku_batch_stock_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '库存批次id',
                                            ...
                                            UNIQUE INDEX `uk_order_no`(`order_no`) USING BTREE,
                                            INDEX `idx_container_code`(`container_code`) USING BTREE,
                                            INDEX `idx_container_stock_id`(`container_stock_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_stock_adjustment_detail`  (
                                              ...
                                              `qty_adjustment` int(11) NOT NULL COMMENT '调整数量',
                                              `sku_batch_attribute_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '批次id',
                                              `sku_batch_stock_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '库存批次id',
                                              `sku_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '商品编码',
                                              `sku_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '商品id',
                                              `stock_abnormal_record_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '库存异常记录ID',
                                              `stock_adjustment_order_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '调整单ID',
                                              PRIMARY KEY (`id`) USING BTREE,
                                              INDEX `idx_stock_adjustment_order_id`(`stock_adjustment_order_id`) USING BTREE,
                                              INDEX `idx_container_stock_id`(`container_stock_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_stocktake_order`  (
                                      ...
                                      `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                      `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                      `abnormal` int(11) NOT NULL COMMENT '异常标识',
                                      ...
                                      `warehouse_area_id` bigint(20) NOT NULL COMMENT '库区ID',
                                      `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                      `warehouse_logic_id` bigint(20) NULL DEFAULT NULL COMMENT '逻辑区ID',
                                      PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `w_stocktake_order_detail`  (
                                             ...
                                             `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                             `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                             `stocktake_order_id` bigint(20) NOT NULL COMMENT '盘点单ID',
                                             ...
                                             `unit_id` bigint(20) NULL DEFAULT NULL COMMENT '盘点基本单位Id：按商品盘点时为SkuId',
                                             `version` bigint(20) NULL DEFAULT NULL,
                                             PRIMARY KEY (`id`) USING BTREE,
                                             INDEX `idx_stocktake_order_id`(`stocktake_order_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_stocktake_record`  (
                                       ...
                                       `qty_original` int(11) NOT NULL COMMENT '原库存数量',
                                       `qty_stocktake` int(11) NOT NULL COMMENT '盘点库存数量',
                                       `sku_batch_attribute_id` bigint(20) NOT NULL COMMENT '批次属性ID',
                                       `sku_batch_stock_id` bigint(20) NOT NULL COMMENT '批次库存ID',
                                       ...
                                       `stocktake_task_detail_id` bigint(20) NOT NULL COMMENT '盘点任务明细ID',
                                       `stocktake_task_id` bigint(20) NOT NULL COMMENT '盘点任务ID',
                                       `version` bigint(20) NULL DEFAULT NULL,
                                       `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                       `work_station_id` bigint(20) NULL DEFAULT NULL COMMENT '盘点工作站ID',
                                       PRIMARY KEY (`id`) USING BTREE,
                                       INDEX `idx_stocktake_order_id`(`stocktake_order_id`) USING BTREE,
                                       INDEX `idx_stocktake_task_id`(`stocktake_task_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_stocktake_task`  (
                                     ...
                                     `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                     `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                     `received_user_id` bigint(20) NULL DEFAULT NULL COMMENT '领单用户id',
                                     `stocktake_create_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '创建方式',
                                     `stocktake_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '盘点方式',
                                     `stocktake_order_id` bigint(20) NOT NULL COMMENT '盘点单ID',
                                     ...
                                     `version` bigint(20) NULL DEFAULT NULL,
                                     `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库',
                                     `work_station_id` bigint(20) NULL DEFAULT NULL COMMENT '工作站',
                                     PRIMARY KEY (`id`) USING BTREE,
                                     UNIQUE INDEX `idx_task_no`(`task_no`) USING BTREE,
                                     INDEX `idx_stocktake_order_id`(`stocktake_order_id`) USING BTREE,
                                     INDEX `idx_stocktake_task_status`(`stocktake_task_status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_stocktake_task_detail`  (
                                            ...
                                            INDEX `idx_stocktake_task_id`(`stocktake_task_id`) USING BTREE,
                                            INDEX `idx_stocktake_order_id`(`stocktake_order_id`) USING BTREE,
                                            INDEX `idx_container_code_face`(`container_code`, `container_face`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_transfer_container`  (
                                         ...
                                         `locked_time` bigint(20) NOT NULL DEFAULT 0 COMMENT '锁定时间',
                                         ...
                                         `warehouse_area_id` bigint(11) NOT NULL COMMENT '最后一次工作的库区',
                                         `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编号',
                                         PRIMARY KEY (`id`) USING BTREE,
                                         UNIQUE INDEX `uk_container_code_warehouse`(`transfer_container_code`, `warehouse_code`) USING BTREE,
...
CREATE TABLE `w_transfer_container_record`  (
                                                ...
                                                `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                                `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                                `container_index` int(11) NOT NULL COMMENT '第几个周转箱',
                                                `destination` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '周转箱目的地',
                                                `picking_order_id` bigint(11) NOT NULL COMMENT '拣选订单ID',
                                                `put_wall_slot_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '播种墙格口',
                                                `seal_time` bigint(20) NOT NULL DEFAULT 0 COMMENT '封箱时间',
                                                `transfer_container_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '周转容器编码',
                                                `transfer_container_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '周转箱记录状态',
                                                `version` bigint(20) NULL DEFAULT NULL,
                                                `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                                `work_station_id` bigint(11) NULL DEFAULT NULL COMMENT '工作站ID',
                                                PRIMARY KEY (`id`) USING BTREE,
                                                UNIQUE INDEX `uk_container_order_order_status`(`transfer_container_code`, `picking_order_id`, `seal_time`) USING BTREE,
                                                INDEX `idx_order`(`picking_order_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_warehouse_area`  (
                                     ...
                                     `temperature_limit` int(11) NOT NULL,
                                     `version` bigint(20) NOT NULL,
                                     ...
                                     `wet_limit` int(11) NOT NULL,
                                     PRIMARY KEY (`id`) USING BTREE,
                                     UNIQUE INDEX `uk_warehouse_area_group_code`(`warehouse_area_code`, `warehouse_group_code`, `warehouse_code`, `delete_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_warehouse_area_group`  (
                                           ...
                                           `warehouse_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仓库编码',
                                           PRIMARY KEY (`id`) USING BTREE,
                                           UNIQUE INDEX `uk_warehouse_area_group_code`(`warehouse_area_group_code`, `warehouse_code`, `delete_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_warehouse_logic`  (
                                      ...
                                      `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT 'Update time',
                                      `update_user` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'Update user',
                                      `delete_time` bigint(20) NOT NULL DEFAULT 0 COMMENT '备注',
                                      `deleted` bit(1) NOT NULL,
                                      `enable` bit(1) NOT NULL,
                                      `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
                                      `version` bigint(20) NOT NULL,
                                      ...
                                      PRIMARY KEY (`id`) USING BTREE,
                                      UNIQUE INDEX `uk_warehouse_logic_area`(`warehouse_area_id`, `warehouse_logic_code`, `delete_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_work_station`  (
                                   ...
                                   PRIMARY KEY (`id`) USING BTREE,
                                   UNIQUE INDEX `uk_station_code_warehouse`(`station_code`, `warehouse_code`, `delete_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_work_station_config`  (
                                          ...
                                          `work_station_id` bigint(11) NOT NULL COMMENT '工作站ID',
                                          PRIMARY KEY (`id`) USING BTREE,
                                          UNIQUE INDEX `uk_work_station_id`(`work_station_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
